...
export const Sidebar = () => {
  ...
  return (
    <div className="w-80 h-full border-l border-slate-200 bg-white flex flex-col flex-shrink-0">
      <Tabs defaultValue="hierarchy" className="flex-1 flex flex-col">
        ...
        <TabsContent value="hierarchy" className="flex-1 flex flex-col min-h-0 mt-0 overflow-y-auto">
        ...
        <TabsContent value="layers" className="flex-1 flex flex-col min-h-0 mt-0 overflow-y-auto">
          <ScrollArea className="flex-1 p-4">
        ...
        <TabsContent value="properties" className="flex-1 flex flex-col min-h-0 mt-0 overflow-y-auto">
          <ScrollArea className="flex-1 p-4">
            {!user ? (
